...
<body>
    <nav  id="myTopnav" class="topnav ">
        <a  href="<?php echo $menu['lien1']; ?>"><?php echo $menu['page1']; ?></a>
        <a  href="<?php echo $menu['lien2']; ?>"><?php echo $menu['page2']; ?></a>
    ...
    <div id="pg" class=" personnal_grid">
        ...
        <a href="<?php echo $menu['lien1']; ?>" id="pg3" class="pg_item pg_item_bg_3">
            <div class="pg_mask">
    ...
    <section class="col-md-6 offset-md-6">
        ...
        <p class="col-md-12 text-center"><?php echo $content; ?></p>
        <div id="scene" class="col-md-12" style="text-align:center"> <img src="<?php echo $gif; ?>" alt="<?php echo $gif_alt; ?>"/></div>
