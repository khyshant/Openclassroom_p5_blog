        ...
        <h2 class="titre_article"> </h2>
            <form id="test" method="post" action="../updatePageOrPost">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control required" id="title" name="title" placeholder="titre" value="<?php echo $contenu['title']; ?>">
                </div>
                <?php
                    if($contenu['type_id']==1){
                ?>
                    <div class="form-group">
                        <label for="function">function</label>
                        <input type="text" class="form-control required" id="function" name="function" placeholder="fonction" value="<?php echo $contenu['function']; ?>">
                    </div>
                <?php
                    ;}
                ?>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control required" id="content" name="content" placeholder=""><?php echo $contenu['content']; ?></textarea>
                </div>
                <div class="form-group">
                    <label for="meta_title">meta_title</label>
                    <textarea class="form-control required" id="meta_title" name="meta_title" placeholder=""><?php echo $contenu['meta_title']; ?></textarea>
                </div>
                <div class="form-group">
                    <label for="meta_description">meta_description</label>
                    <textarea class="form-control required" id="meta_description" name="meta_description" placeholder=""><?php echo $contenu['meta_description']; ?></textarea>
                </div>
                <?php
                if($contenu['type_id']==2)
                {
                    $checked = "";
                    if($contenu['comment_auth']==1) {
                        $checked = "checked";
                    }
                    ?>
                    <div class="form-group">
