...
class Content {
     ...
     * @return array
     */
    public function listContent($type_id,$display)
    {
        $db = Manager::getinstance();
        $contentList = array();
     ...
     * @return mixed
     */
    public function getContentById($id,$type_id,$display)
    {
        $contents = new Content;
        $contents = $contents->listContent($type_id,$display);
